...
namespace HoloToolkit.Sharing.Tests
{
    ...
    public class CustomMessages : Singleton<CustomMessages>
    {
        ...
        public void SendFlag()
        {
            ...
            Debug.LogError("CallFromCustomMessage");
            // If we are connected to a session, broadcast that the target exploded.
            if (this.serverConnection != null && this.serverConnection.IsConnected())
            {
                Debug.LogError("CallFromCustomMessageAfterIf");
                // Create an outgoing network message to contain all the info we want to send.
                NetworkOutMessage msg;
                Debug.LogError("CallFromCustomMessageAfterIf");
                msg = CreateMessage((byte)TestMessageID.Flags);
            ...
            Debug.LogError("EndOfCustomMessage");
        }
